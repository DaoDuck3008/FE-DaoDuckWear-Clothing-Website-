  ...
  return (
    <section className="relative min-h-[80vh] lg:min-h-screen flex items-center justify-center bg-stone-50 pt-20 lg:pt-32 text-center overflow-hidden">
      ...
      <div className="relative z-10 px-6">
        <h1
          className="font-serif text-5xl lg:text-8xl font-bold tracking-tighter text-white drop-shadow-2xl opacity-0 animate-fade-in transition-all duration-1000"
          style={{ opacity: 1 }}
        >
          THE DAODUCK WEAR
        </h1>
