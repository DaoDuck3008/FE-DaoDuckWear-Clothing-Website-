...
- **Hooks**: Always extract complex logic into separate custom hooks files (e.g., `useProductForm.ts`).
- **Suffixes**: No special suffixes like `.component.tsx` are needed.
...
- **Target**: Maintain this logic in `apps/frontend/types/product.ts`.
